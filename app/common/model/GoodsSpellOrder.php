...
class GoodsSpellOrder extends Model
{
    protected $table = 'goods_spell_order';
    protected $pk = 'id';
     ...
     * author：liu_sd
     */
	public function getSpellGoods($applet_id,$key_word=null,$start_time=null,$end_time=null)
    {
        $where = array();
       ...
       if ($start_time!==null && $end_time!==null)
        ...
        $seckill_goods = $this
            ...
            ->where($where)
            ->field('gse.id,gse.is_up,gse.create_time,gse.update_time,g.name,g.picture,gse.start_time,end_time,stime_range,etime_range,order_time')
            ->paginate(8);
